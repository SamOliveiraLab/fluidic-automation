        ...
        <div style={{ padding: "20px 24px" }}>
          {loading ? (
            <div style={{ textAlign: "center", padding: "32px 0" }}>
              ...
              />
              <p style={{ color: th.textMuted, fontSize: 15 }}>
                Analyzing data...
              </p>
            </div>
          ) : (
      ...
      >
        ...
        >
          <div style={{ flex: 1, minWidth: 200 }}>
            ...
            <p style={{ margin: "4px 0 0", fontSize: 14, color: th.textMuted }}>
              {subtitle}
            </p>
          </div>
          <div
        ...
        {has ? (
          ...
          >
            <div style={{ fontSize: 36, marginBottom: 12, opacity: 0.35 }}>
              {emptyIcon}
            </div>
            <div
              style={{
        ...
        {step === 1 && (
          <div style={{ padding: "24px" }}>
            ...
            <div style={{ marginBottom: 16 }}>
              ...
              />
              <p
                style={{ margin: "6px 0 0", fontSize: 13, color: th.textMuted }}
              >
  ...
  return (
    ...
    >
        ...
        <div style={{ padding: "0 20px", marginBottom: 28 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            ...
            <div>
              ...
              <div
                style={{ fontSize: 12, color: th.textMuted, fontWeight: 500 }}
              >
      ...
      <div
        style={{
          marginLeft:
            typeof window !== "undefined" && window.innerWidth < 768 ? 0 : 220,
          minHeight: "100vh",
          position: "relative",
          zIndex: 1,
        }}
      >
        ...
        {page === "reactors" && (
          <div style={{ padding: "24px" }}>
            ...
            >
              <div>
                <p style={{ margin: 0, fontSize: 15, color: th.textSecondary }}>
